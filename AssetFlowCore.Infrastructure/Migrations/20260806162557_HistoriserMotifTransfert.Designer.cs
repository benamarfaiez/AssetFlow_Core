...
namespace AssetFlowCore.Infrastructure.Migrations
{
    ...
    [Migration("20260806162557_HistoriserMotifTransfert")]
    partial class HistoriserMotifTransfert
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssetFlowCore.Domain.Entities.TicketTransferHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("t_ticket_transfer_histories", (string)null);
                });
            ...
            modelBuilder.Entity("AssetFlowCore.Domain.Entities.TicketTransferHistory", b =>
                {
                    b.HasOne("AssetFlowCore.Domain.Entities.MaintenanceTicket", null)
                        .WithMany()
