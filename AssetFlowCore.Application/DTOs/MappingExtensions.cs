...
public static class MappingExtensions
{
    ...
    public static TicketResponseDto ToDto(this MaintenanceTicket ticket) =>
        new(ticket.Id, ticket.AssetId, ticket.Title, ticket.Criticality.ToString(), ticket.Status.ToString(), ticket.AssignedTeam);
}